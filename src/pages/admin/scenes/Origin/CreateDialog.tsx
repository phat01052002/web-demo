...
const CreateOrigin: React.FC<CreateOriginProps> = (props) => {
    ...
    const handleAddCategory = async (name: string) => {
        ...
        const res = await PostApi('/admin/create/origin', localStorage.getItem('token'), { name });
